<?php
/**
 * wikka/ReferrerBlacklistModelTest.php
 *
 * Usage (run from WikkaWiki root dir):
 * > phpunit --stderr test/models/ReferrerBlacklistModelTest
 *
 */
...
class ReferrerBlacklistModelTest extends PHPUnit_Framework_TestCase {
    ...
    public function testInstantiates() {
        $this->assertInstanceOf('ReferrerBlacklistModel', $this->model);
    }
}
